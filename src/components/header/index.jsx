...
function Header() {
  return (
    <div className="h-[34vw] my-8 mx-auto bg-header-img relative rounded-2xl overflow-hidden max-xl:h-[315px]">
      ...
      <div className="absolute flex flex-col items-start gap-[1.5vw] max-w-[95%] max-lg:p-1 max-md:p-1 max-sm:p-1 h-auto p-10 top-5 left-[2vw] header-animation ">
        <h1 className="font-medium text-white text-responsive leading-tight">
          Check out our awesome recipie app{" "}
          <span className=" font-bold">Meals</span>
        </h1>
        <p className="text-white text-[20px] max-md:text-base pt-2">
