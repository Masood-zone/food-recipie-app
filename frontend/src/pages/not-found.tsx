...
const NotFound = () => {
  return (
    <div className="bg-primary-foreground py-6 sm:py-8 lg:py-12 h-screen">
      <div className="mx-auto max-w-screen-lg px-4 md:px-8">
        <div className="grid gap-8 sm:grid-cols-2">
          {/* Image - Start */}
          <div className="h-80 overflow-hidden rounded-lg shadow-lg md:h-auto">
            <img
          ...
          <div className="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
            ...
            <h1 className="mb-2 text-center text-2xl font-bold sm:text-left md:text-3xl">
              Page not found
            </h1>

            <p className="mb-4 text-center sm:text-left md:mb-8 md:text-lg">
